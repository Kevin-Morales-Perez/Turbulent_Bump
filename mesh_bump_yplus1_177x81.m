...
domHgt=5;                            %Domain Height (m)
domLgt=50;                          %Domain Length (m)
...
if (distPlat+ bumpLgt)<domLgt
    ...
    nx=177;% number of cells in x axis 
    ny=81;% number of cells in y axis
    ...
    dx_1=(4.25e-6)*450;%Lenght of the first cell at the leading and trailing edge
    ...
    dy_1=4.25e-6;% Height of the first cell (m);0.00021,0.0001;%
